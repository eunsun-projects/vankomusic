...
const Player = forwardRef((_props, ref: React.Ref<THREE.PerspectiveCamera>) => {
	return (
		<PerspectiveCamera
			ref={ref}
			fov={95}
...
function CircleScene({ audio, joysticRef }: CircleSceneProps) {
	const [_previousPosition, setPreviousPosition] = useState(
	...
	return (
		...
		>
			...
			>
				...
				<fog args={["#a293c9", 10, 300]} attach="fog" />

				{ready && joysticRef && (
					<CircleScene audio={audio} joysticRef={joysticRef} />
				)}
