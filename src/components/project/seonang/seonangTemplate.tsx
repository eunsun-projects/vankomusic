// @ts-nocheck - React 19 compatibility issues with react-spring
"use client";
...
import { GasaModal, lyrics, MvModal, Saju } from "@/components/project/seonang";
...
export default function SeonangTemplate() {
	...
	useEffect(() => {
		if (manager.current && !yes) {
			let bing = false;
			manager.current.on("move", (_event, data) => {
	...
	useEffect(() => {
		...
		setTimeout(() => {
			...
			// const _nippleRepeated = document.querySelector(
			// 	'[id*="nipple_"]',
			// ) as HTMLElement;
				...
				>
					<div className={styles.yesbtnbox}>
						<div className={styles.yesbtnin}>
							...
							<p className={styles.yesy} onClick={handleYesClick}>
								Y
							</p>
						</div>
			...
			<div className={styles.seonangpage}>
				<div className={styles.seonangbox}>
					...
					<div className={styles.centerimg}>
						<div className={styles.pilar}>
							{/* @ts-ignore - React 19 compatibility issue with react-spring */}
						...
						>
							...
							<img
								...
								src={
									dog || dogTwo
										? "/assets/img/dog_standing.webp"
										: "/assets/img/dog_sit.webp"
								}
								alt="dotsit"
							/>
				...
				<div className={styles.waterbox}>
					...
					<animated.img
						...
						style={{ opacity: opacity, touchAction: "none" }}
						alt="water"
					></animated.img>
