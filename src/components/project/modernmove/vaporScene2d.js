...
export default function VaporwaveScene2d({threeD, ready, audio, play}){
    ...
    return (
        <animated.div className={styles.canvas2d} style={{ opacity: opacity, position: 'absolute', zIndex: "1" }}>
            <img ref={earthRef} src="/assets/gifs/earth3.gif" style={{position: "absolute", top: "130px", zIndex: "2", opacity: earth ? "1" : "0", transition: "transform 7s"}} />
            <img 
