...
const VolumeControl = styled.div`
    ...
    input[type='range'] {
        ...
        &::-webkit-slider-thumb {
            ...
            width: 12px;
            border-radius: 50%;
            background: ${(props) => (props.$volume > 0 ? "aqua" : "aqua")};
            margin-top: -3px;
            cursor: pointer;
        }
...
function VolumeNob({volume, setVolume, mobile}){
    ...
    return(
        <div className={styles.volume_nob} style={{ display : mobile ? "none" : "flex", opacity : mobile ? "0" : "1" }}>
