...
export default function IfMobile(){
    ...
    return(
        <>        
            {mobile && (
                <div style={{ position: "fixed", display: "flex", justifyContent:"center", alignItems:"center", gap: "1rem", flexDirection:"column", color: "white", fontFamily: "DungGeunMo", width: "100%", height: "100%", backgroundColor: "blue", zIndex:"999"}}>
