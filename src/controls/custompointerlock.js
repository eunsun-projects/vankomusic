...
class CustomPointerLockControls extends EventDispatcher {
    ...
    onTouchMove(e) {
        ...
        case 1:
            ...
            // console.log(this.domElement.querySelector('canvas')) 여기도 뒤에 querySelector 있었음
    ...
    lock() {
        ...
        this.domElement.requestPointerLock() // this.domElement.querySelector('canvas') 가 있었음
    }
